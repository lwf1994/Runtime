...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    //    NSString *str = [NSArray arrayWithObject:@"string"];
    //    NSLog(@"%@", str);
    RTObj *obj = [[RTObj alloc] init];
    [obj getAllObj];
    NSObject *oject = [[NSObject alloc] init];
    NSString *str = @"runtime添加的变量";
    // 添加属性
    objc_setAssociatedObject(oject, &WFObjProKey, str, OBJC_ASSOCIATION_COPY);
    
    // 获取属性
    id objValue = objc_getAssociatedObject(oject, &WFObjProKey);
